...
const languageDictionar = {
  english: 'Tag Cloud',
  hindi: 'टैग क्लाउड',
  tamil: 'குறிச்சொல் புடவை',
  telugu: 'ట్యాగ్ క్లౌడ్',
};


function Tapcloud({ tag_cloud, onTagClick,searchInitiated,lang }) {
  ...
  return (
    <div className="product-categorie">
      <div className='tag'>
        <h3 className="r">{languageDictionar[lang]}</h3>
